...
VS Code Live Share extension is installed following this lesson: [Installing and Using VS Code Live Share](https://new.learnhowtoprogram.com/prework/getting-started-with-working-remotely/installing-and-using-vs-code-live-share)
