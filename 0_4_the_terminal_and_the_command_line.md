...
For Window users, the following exercise relies on you have installed Git Bash from the pre-work lesson: [Introduction to the Command Line](https://new.learnhowtoprogram.com/introduction-to-programming/getting-started-with-intro-to-programming/introduction-to-the-command-line) 
...
>Note!
>If you are getting an error message that states “code command not found” you need to revisit this prework lesson: [Text Editor: Visual Studio Code](https://new.learnhowtoprogram.com/introduction-to-programming/getting-started-with-intro-to-programming/text-editor-visual-studio-code).
