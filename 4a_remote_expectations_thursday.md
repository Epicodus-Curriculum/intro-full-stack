...
There are also two lessons that cover [Preparing for Your First Code Review](/introduction-to-programming/git-html-and-css-part-2/homework-preparing-for-your-first-code-review), including helpful strategies. As well as a lesson covering [Git Expectations for Independent Projects](/introduction-to-programming/git-html-and-css-part-2/homework-git-expectations-for-independent-projects).
