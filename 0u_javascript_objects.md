...
When [we first talked about objects](/introduction-to-programming/javascript-and-web-browsers/javascript-data-types) we introduced these as containers for related data, data that can be _any_ JavaScript data type. 
