...
2. Open your `.html` file using VS Live Server. Revisit lesson [VS Code Live Server](https://www.learnhowtoprogram.com/introduction-to-programming/git-html-and-css/vs-code-live-server) if needed.
