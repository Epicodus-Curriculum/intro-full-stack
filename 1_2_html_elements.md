...
1. Create a new directory with any name you like. Inside that directory create a new `.html` file. Revisit the lesson [The Terminal and the Command Line](/introduction-to-programming/git-html-and-css-part-2/the-terminal-and-the-command-line) if you are not sure how to complete this step.
...
2. Open your `.html` file using VS Live Server. Revisit lesson [VS Code Live Server](/introduction-to-programming/git-html-and-css-part-2/vs-code-live-server) if needed.
