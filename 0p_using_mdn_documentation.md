...
So far we've introduced methods by their data type and by their name, like in the lesson on [String and Number Methods](/introduction-to-programming/javascript-and-web-browsers-part-2/practice-string-and-number-methods):
